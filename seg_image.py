...
from image_module import ImageBasedModel
import myutils

# constants
WINDOW_NAME = 'COCO detections'
user_config = {
        'config_file_obj': 'image_module/configs/InstanceSegmentation/pointrend_rcnn_R_50_FPN_3x_coco.yaml',
        'config_file_skeleton': 'image_module/configs/COCO-Keypoints/keypoint_rcnn_R_101_FPN_3x.yaml',
        'opts_obj': ['MODEL.WEIGHTS',
                     'detectron2://PointRend/InstanceSegmentation/pointrend_rcnn_R_50_FPN_3x_coco/164955410/model_final_3c3198.pkl'],
        'opts_skeleton': ['MODEL.WEIGHTS',
                          'detectron2://COCO-Keypoints/keypoint_rcnn_R_101_FPN_3x/138363331/model_final_997cc7.pkl'],
        'conf_thres_obj': 0.5,
        'conf_thres_skeleton': 0.7,
    }
