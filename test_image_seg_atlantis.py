...
from atlantis.dataloader import ATLANTIS
...
def get_arguments(
    ...
    batch_size=1,
    num_workers=1,
    data_directory="./atlantis/atlantis",
    restore_from="./output/atlantis/epoch30.pth",
    save_path="./output/atlantis_test_results_epoch30"
):
